"""
Sandbox API can be explored further at <cloudshell_server>:82/api/v2/explore
"""
...
if __name__ == "__main__":
    ELASTICUBE_NAME = 'QS_ElastiCube_new'
    sisense_rest = SisenseRest(server="localhost", username="<sisense user>", password="<sisense password>")
